...
if __name__ == "__main__":
    ...
    print("Exp 48: Impact of the delayed factor")

    exp_name = "exp48_impact_delayed"
    ...
    if not args.o:
        ...
        servers = [
            ...
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 0.0, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 0.2, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 0.4, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 0.6, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 0.8, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 1.0, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 1.2, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 1.4, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 1.6, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 1.8, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 2.0, 'enable_scaling_factor': True}, 'semi-async'],
    ...
    for running_stats, cfg_data in outputs2:
        ...
        local_df_name = f"{parts[-2]}-f{f}-id{impact_delayed}-{name_suffix}"
