...
if __name__ == '__main__':
    ...
    if not args.o:
        ...
        servers = [
            [AFL.PessimisticServer,{'learning_rate': 0.1, 'k': 3, 'aggregation_bound': 40}],
            [AFL.PessimisticServer,{'learning_rate': 0.1, 'k': 3}],
        ]
        f0_keys = []
    ...
    for running_stats, cfg_data in outputs2:
        ...
        local_df_name = f'{parts[-2]}-f{f}-{server_lr}-{kardam_damp}-{name_suffix}'
