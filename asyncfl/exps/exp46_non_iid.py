...
if __name__ == "__main__":
    ...
    print("Exp 46: Non IID")

    exp_name = "exp46_non_iid"
    ...
    if not args.o:
        ...
        var_sets = [
            ...
            # {"num_clients": 40, "num_byz_nodes": 0, "flame_hist": 3},
            {"num_clients": 100, "num_byz_nodes": 0, "flame_hist": 3},
        ]
        ...
        servers = [
            ...
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "aggregation_bound": 100,"disable_alpha": True}, 'semi-async'],
        ...
        for _r, server, var_set, atk in itertools.product(range(repetitions), servers, var_sets, attacks):
            ...
            if ct_key not in generated_ct.keys():
                ct_clients = np.abs(np.random.normal(500, 50.0, num_clients - f))
                f_ct = np.abs(np.random.normal(500, 50.0, f))
            ...
            configs.append(
                {
                    ...
                    "clients": {
                        "client": AFL.Client,
                        "client_args": {"learning_rate": server_lr, "sampler": "limitlabel", "sampler_args": (4, 42+_r)},
