...
if __name__ == "__main__":
    ...
    print("Exp 47: pess options")

    exp_name = "exp47_pess_options"
    ...
    if not args.o:
        ...
        servers = [
            ...
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": True, 'enable_scaling_factor': False}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'enable_scaling_factor': True}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False}, 'semi-async'],
    ...
    for running_stats, cfg_data in outputs2:
        ...
        local_df_name = f"{parts[-2]}-f{f}-{server_lr}-{num_buffers}-esf{enable_scaling_factor}-da{disable_alpha}-{name_suffix}"
