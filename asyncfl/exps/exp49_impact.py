...
if __name__ == "__main__":
    ...
    print("Exp 49: Impact of the delayed factor")

    exp_name = "exp49_impact"
    ...
    if not args.o:
        ...
        servers = [
            ...
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 0.0, 'enable_scaling_factor': False}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 0.5, 'enable_scaling_factor': False}, 'semi-async'],
            ...
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 1.5, 'enable_scaling_factor': False}, 'semi-async'],
            [AFL.PessimisticServer, {"learning_rate": server_lr, "k": 6, "disable_alpha": False, 'impact_delayed': 2.0, 'enable_scaling_factor': False}, 'semi-async'],
