...
if __name__ == "__main__":
    ...
    print("Exp 59: Show byzantine sampling effect")

    exp_name = "exp59_show_byz_sampling_effect"
    ...
    if not args.o:
        ...
        sampler_wrong = {'sampler': 'nlabels', 'sampler_args': {'limit': limit, 'use_client_order': False}}
        sampler_correct = {'sampler': 'nlabels', 'sampler_args': {'limit': limit, 'use_client_order': True}}
        byz_sampler_wrong = {'sampler': 'nlabels', 'sampler_args': {'limit': limit, 'use_client_order': True}}
        byz_sampler_wrong_doulbe = {'sampler': 'nlabels', 'sampler_args': {'limit': limit, 'use_client_order': False}}
        ...
        attacks = [
            ...
            [AFL.NGClient, {**{"magnitude": 10}, **byz_sampler_wrong}],
            [AFL.NGClient, {**{"magnitude": 10}, **byz_sampler_wrong_doulbe}],
            # [
            #     AFL.PixelClient,
            #     {
            #         "sampler": "uniform",
        ...
        if True:
            AFL.Scheduler.plot_data_distribution_by_time(configs, use_cache=False, filter_byzantine=True)
            AFL.Scheduler.plot_data_distribution_by_time(configs, use_cache=True, filter_byzantine=False, plot_name_prefix='data_dist_byz')
            exit()
