...
if __name__ == '__main__':
    ...
    print('Exp 19: Run related work in Cifar10 dataset and Kardam to find damp value. Attacks: Negative gradient (magnitude=10) '
          +'and random perbutation (alpha_atk = 0.2). '
          +'Kardam')
